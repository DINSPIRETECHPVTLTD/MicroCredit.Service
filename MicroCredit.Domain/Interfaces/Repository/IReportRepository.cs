...
public interface IReportRepository
{
    ...
    byte[] Generate(List<MemberWiseCollectionResponseDto> data, List<ExpenseResponse>? expenses = null, List<LedgerReportDto>? ledgers = null, List<MemberWiseCollectionResponseDto>? closedData = null);
    public void GenerateRepaymentSheet(XLWorkbook wb, List<MemberWiseCollectionResponseDto> data);

    public void GenerateClosedLoansSheet(XLWorkbook wb, List<MemberWiseCollectionResponseDto> data);
