        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClaimedAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Loans_MemberId_OpenLoanUnique",
                table: "Loans",
                column: "MemberId",
                unique: true,
                filter: "[IsDeleted] = 0 AND [Status] IN ('Active', 'Defaulted')");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Members_Aadhaar",
                table: "Members",
                column: "Aadhaar",
                unique: true,
                filter: "[Aadhaar] IS NOT NULL");
